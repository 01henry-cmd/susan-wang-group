        ...
        >
          <Link href="/contact">
            <motion.div
              ...
              className="group flex items-center gap-4 text-white shadow-xl shadow-black/20 px-6 py-3.5 cursor-pointer transition-opacity duration-300 hover:opacity-90 rounded-full"
